      ...
      <h4 class="center" style="color:#424242 !important; font-weight:bold;">ENQUIRIES</h4> 
					<table class="table responsive-table bordered ">
						...
						<tbody>
							...
							?>
									   <tr>
										<td><?php echo $enquiry['id'][$i]; ?></td>
										<td><?php echo $customer[$i]['name']; ?></td>
										<td><?php echo $customer[$i]['email']; ?></td>
										<td><?php echo $customer[$i]['phone']; ?></td>
										<td><?php echo $enquiry['message'][$i]; ?></td>
										<td><?php echo $property[$i]['property_type']; ?></td>
                                        <td><?php echo $property[$i]['property_location']; ?></td>
                                        <td><?php echo $property[$i]['price']; ?></td>
                                        <td><img src="<?php echo base_url();?>uploads/<?php echo $property[$i]['picture_new']; ?>" class="responsive-img"/></td>
									</tr>
							<?php	
