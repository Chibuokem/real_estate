...
<div class="navbar-fixed">
    <nav>
      <div class="nav-wrapper mynav1">
       <a href="../index.php" class="brand-logo logosize">STVSMB ENUGU STATE</a>
      <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
      <ul class="right hide-on-med-and-down">
        <li><a href="signup.php">VIEW FEEDBACKS</a></li>
        <li><a href="login.php">EDIT POST</a></li>
...
<div class="col s12 m6 l4 fom1"><h4 style="color:#424242 !important; font-weight:bold;">ADD NEWS</h4></div>
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s6">
          ...
          <label for="icon_prefix2">Text 1</label>
        </div>
      </div>
     <div class="file-field input-field">
      <div class="btn">
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">mode_edit</i>
          <textarea id="icon_prefix2" class="materialize-textarea"></textarea>
          <label for="icon_prefix2">Text 2</label>
        </div>
      </div>
       <div class="file-field input-field">
      <div class="btn">
    ...
    <form class="col s12">
      <div class="row">
        <div class="input-field col s6">
          <i class="material-icons prefix">mode_edit</i>
          <textarea id="icon_prefix2" class="materialize-textarea"></textarea>
          <label for="icon_prefix2">Text 3</label>
        </div>
      </div>
      <div class="row">
        <div class="input-field col s12 sub">
          <!--<input type="submit" value="SIGN UP" class="validate" required/>-->
           
          <button id="register" class="btn register validate success">POST NEWS </button>
          <label></label>
        </div>
      </div>
